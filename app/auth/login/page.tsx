...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600 p-12 flex-col justify-between text-white relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Welcome Back to Your Form Dashboard
            </h1>
            <p className="text-lg text-white/90 mb-12">
              Access your forms, track responses, and grow your business with powerful analytics.
            </p>

            <div className="space-y-6">
              {[
                { icon: Zap, title: 'Lightning Fast', desc: 'Create and manage forms in seconds' },
                { icon: Shield, title: 'Secure & Private', desc: 'Your data is encrypted and protected' },
                { icon: TrendingUp, title: 'Real-time Analytics', desc: 'Track responses and insights instantly' },
                { icon: CheckCircle2, title: 'Always Free', desc: 'Premium features at no cost' }
              ].map((feature, i) => (
