...
import { Smartphone, Globe, BarChart3, Users, Zap, Heart } from 'lucide-react'
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            ...
            <p className="text-lg text-white/90 mb-12">
              Join thousands of Indian businesses creating powerful forms with ease.
            </p>

            <div className="grid grid-cols-2 gap-6 mb-12">
              {[
                { value: '10,000+', label: 'Forms Created' },
                { value: '50,000+', label: 'Responses' },
            ...
            <div className="space-y-4">
              ...
              {[
                { icon: Smartphone, text: 'WhatsApp & Email Integration' },
                { icon: BarChart3, text: 'Real-time Analytics Dashboard' },
                { icon: Globe, text: 'Custom Branding & Domain' },
                { icon: Users, text: 'Unlimited Form Responses' },
                { icon: Zap, text: 'Lightning Fast Performance' },
                { icon: Heart, text: 'Premium Features Free' }
              ].map((feature, i) => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Start building beautiful forms today - it's free!</p>
          </div>
